...
Also, percentages are my best known way at the moment to make websites responsive to different screens as it takes an amount that is calculated depending on the individual user's resolution.
